...
private val log = LoggerFactory.getLogger(DefaultKtorExceptionHandler::class.java)

/**
 * Default global exception handler that maps common exceptions to RFC 7807 [ProblemDetail] responses.
 */
@Singleton
class DefaultKtorExceptionHandler : KtorExceptionHandler {
